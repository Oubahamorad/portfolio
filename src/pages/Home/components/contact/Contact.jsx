...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('template_22pcsta', 'service_ts54bvn', formref.current, {
        publicKey: 'GkSHI26fdFxzFZbiy',
      })
      .then(
        (result) => {
          setSuccess(true);
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div variants={variants} className="item">
          <h2>Mail</h2>
          <span>moradoubaha97@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Moroc casablanca</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+212658828155</span>
        </motion.div>
      </motion.div>
